@extends('layouts.main')
  ...
  <h1 class="text-4xl m-10 font-semibold text-yellow-600 mt-36 text-center">Progress Anda Hari Ini</h1>
  <div class="container flex justify-center items-center">
    <div class="stats shadow text-center bg-white mb-36">
      <div class="stat">
        ...
        <div class="stat-title text-slate-800">Jumlah Task yang belum selesai hari ini</div>
      ...
      <div class="stat">
        ...
        <div class="mt-3 stat-value text-secondary">A+</div>
      </div>
      ...
      <div class="stat">
        ...
        <div class="stat-title text-slate-800">Tasks Selesai</div>
      </div>
    </div>
  </div>
