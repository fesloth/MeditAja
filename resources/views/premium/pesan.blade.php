...
<div class="flex justify-center items-center h-screen">
    <div class="px-28 py-28 rounded-lg shadow-lg max-sm:mx-5 max-sm:px-20 max-sm:py-20">
        ...
        @foreach ($messages as $message)
            <p class="text-lg text-center italic text-gray-700 hidden">{{ $message->content }}</p>
        @endforeach
