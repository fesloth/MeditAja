  ...
  <div class="navbar bg-[91D086] text-slate-900 shadow-xl">
    ...
    <div class="container mx-auto p-6">
      <section class="mt-4">
          ...
          <a href="/createTodo" class="bg-[93CE89] text-white px-5 py-2 rounded-lg hover:bg-[91D086] inline-block">Tambah Tugas</a>
        ...
        <table class="border-collapse border border-slate-950 w-full table-auto mt-9">
          <thead class="bg-[76AA6E] text-white">
              <tr class="border-collapse border border-slate-950">
                  <th class="px-4 py-2 border border-slate-950">Prioritas</th>
                  <th class="px-4 py-2 border border-slate-950">Deskripsi</th>
                  <th class="px-4 py-2 border border-slate-950">Tenggat Waktu</th>
                  <th class="px-4 py-2 border border-slate-950">Status</th>
                  <th class="px-4 py-2 border border-slate-950">Aksi</th>
              </tr>
          </thead>
          <tbody>
            @foreach($task as $t)
