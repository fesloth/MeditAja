    ...
    <div class="card w-96 bg-base-100 mx-4 shadow-xl">
      <div class="card-body items-center text-center m-10">
        ...
        <div class="card-actions">
          <button class="btn btn-primary">Coba meditasi</button>
        </div>
      </div>
    </div>
    <div class="card w-96 bg-base-100 mx-4 shadow-xl">
      <div class="card-body items-center text-center m-10">
        ...
        <div class="card-actions">
          <button class="btn btn-primary">Tulis kegiatan harianmu</button>
        </div>
      </div>
    </div>
    <div class="card w-96 bg-base-100 mx-4 shadow-xl">
      <div class="card-body items-center text-center m-10">
        ...
        <div class="card-actions">
          <button class="btn btn-primary">Ayo konsultasi!</button>
        </div>
      </div>
    </div>
  </div>
